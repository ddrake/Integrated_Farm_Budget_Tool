...
urlpatterns = [
    ...
    path('farmcrops/<int:farmyear>/addbudget/', FarmCropAddBudgetView.as_view(),
         name='addbudget'),
    path('farmcrops/<int:farmyear>/deletebudget/', FarmCropDeleteBudgetView.as_view(),
         name='deletebudget'),
    ...
    path('detailedbudget/<int:farmyear>/table/',
    ...
    path('sensitivity/<int:farmyear>/sens_table/',
