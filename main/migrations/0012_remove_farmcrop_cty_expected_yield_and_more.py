...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0011_farmbudgetcrop_budget_crop'),
    ]

    operations = [
        migrations.RemoveField(
            model_name='farmcrop',
            name='cty_expected_yield',
        ),
        migrations.RemoveField(
            model_name='farmcrop',
        ...
        migrations.AlterField(
            ...
            field=models.SmallIntegerField(blank=True, help_text='Estimated price volatility factor', null=True, validators=[main.validators.validate_range], verbose_name='price volatility factor'),
        ),
        migrations.AlterField(
            model_name='farmcrop',
            name='proj_harv_price',
            field=models.FloatField(blank=True, help_text='Estimate for projected harvest price', null=True, validators=[main.validators.validate_range], verbose_name='projected harvest price'),
        ),
        migrations.AlterField(
            model_name='farmcrop',
            name='prot_factor',
