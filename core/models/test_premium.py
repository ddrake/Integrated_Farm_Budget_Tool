...
class PremiumTestCase(TestCase):
    ...
    def test_with_default_values(self):
        ...
        expected = (
            np.array(
                [[0.9 ,  1.28,  1.79,  2.62,  3.79,  6.38, 12.72 , 26.66],
                 [0.71,  0.87,  1.01,  1.36,  1.91,  3.12,  6.39, 13.83],
                 [0.73,  0.99,  1.37,  1.96,  2.69,  4.22,  7.90, 15.34]]).T,
            np.array(
    ...
    def test_3000_acres_corn_in_champaign(self):
        ...
        expected = (
            np.array(
                [[0.83,  1.16,  1.62,  2.4 ,  3.5 ,  5.95, 11.99, 25.38],
                 [0.67,  0.81,  0.94,  1.22,  1.74,  2.85,  5.87, 12.82],
    ...
    def test_300_acres_wheat_champaign(self):
        ...
        expected = (
            np.array(
                [[3.52,  4.32,  5.2 ,  6.2 ,  7.64, 11.08, 19.17, 34.56],
                 [2.93,  3.61,  4.33,  5.16,  6.43,  9.41, 16.41, 29.77],
                 [2.48,  3.  ,  3.59,  4.27,  5.36,  7.94, 14.01, 25.62]]).T,
