...
# 'ql': True,     # True to use quality loss
# 'ta': True,     # True to use trend-adjusted yields
# 'ya': False,    # True to use yield averaging
# 'yc': False,    # True to use yield cup
# 'ye': False,    # True to use yield exclusion
#
...
class PremiumTestCase(TestCase):
    ...
    def test_800_acres_corn_in_champaign_ta_ye(self):
        # farm-based verified with RMA worksheets
        settings = {
            'rateyield': 220,
            'adjyield': 220,
